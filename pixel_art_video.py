...
class ArtConverter:
    def __init__(self, path='video/test.mp4', pixel_size=4, color_lvl=8):
        pg.init()
        self.path = path
        ...
        self.record = False
        self.recorder = cv2.VideoWriter('pixel_art_video.mp4', cv2.VideoWriter_fourcc(*'mp4v'), self.rec_fps, self.RES)
