...
class ArtConverter:
    def __init__(self, path='video/test.mp4', font_size=8, color_lvl=8):
        pg.init()
        self.path = path
        ...
        self.record = False
        self.recorder = cv2.VideoWriter('ascii_col.mp4', cv2.VideoWriter_fourcc(*'mp4v'), self.rec_fps, self.RES)
...
class ArtConverter:
    def __init__(self, path='video/test.mp4', font_size=12):
        ...
        self.rec_fps = self.capture.get(cv2.CAP_PROP_FPS)
        self.record = False
        self.recorder = cv2.VideoWriter('ascii.mp4', cv2.VideoWriter_fourcc(*'mp4v'), self.rec_fps, self.RES)
